...
# lazy_read_bench.sh
#
# Collect lazy-read conflict detection metrics from ALL OSDs,
# running the workload once with the feature disabled, once enabled.
#
# Outputs:
...
# ── Phase 1: lazy read DISABLED ───────────────────────────────────
echo ""
echo "======== PHASE 1: lazy read DISABLED ========"
...
# ── Phase 2: lazy read ENABLED ────────────────────────────────────
echo ""
echo "======== PHASE 2: lazy read ENABLED ========"
